...
class ArbolID3(Arbol):
    ...
    @classmethod
    def id3(cls, X: np.ndarray, y: np.ndarray, atributos: List[int], profundidad_max: None, minimas_obs_n: int = 0, minimas_obs_h: int = 0, ganancia_minima: int = 0, profundidad_actual: int = 0) -> "ArbolID3":
